...
// set reset - 3,3v
#define CS   43//10 //Chon chip - cs lcd 
#define SDA  45//11 //Data SPI  - sdi lcd
#define CD   47//12 //Chot du lieu Command va Data (C/D)  - a0 lcd
#define SCK  49//13 //Clock SPI  - sclk lcd
